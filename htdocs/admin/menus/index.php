...
llxHeaderLayout('', $langs->trans("Menus"), $langs->trans("Menus"), '', '', 0, 0, $arrayofjs, $arrayofcss);
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="card card-custom gutter-b example example-compact">
							...
							print dol_get_fiche_head_layout($head, 'editor', '', -1);

							print '<br /><p style="line-height:15px;">'.$langs->trans("MenusEditorDesc")."</p><br>\n";
							print "<br>\n";
							...
							if ($user->admin)
							{
								$newcardbutton .= dolGetButtonTitleLayout($langs->trans('New'), '', 'fa fa-plus-circle', DOL_URL_ROOT.'/admin/menus/edit.php?menuId=0&action=create&menu_handler='.urlencode($menu_handler).'&backtopage='.urlencode($_SERVER['PHP_SELF']));
							}

							print '<div class="row"><div class="col-sm-11"><form enctype="multipart/form-data" class="form nocellnopadd" method="POST" action="'.$_SERVER["PHP_SELF"].'" name="newmenu">';
							...
							print ' &nbsp; <input type="submit" class="btn btn-success mr-2 button-save" value="'.$langs->trans("Refresh").'">';

							print '</form>';

							print '</div><div class="col-sm-1">';
							print $newcardbutton;
							print '</div>';
							print '</div><br /><br />';
