...
class MenuManager {
  ...
  function loadMenu($forcemainmenu='',$forceleftmenu='') {
	...
	*
     ...
     */
    function showmenuLayout($mode, $moredata=null)
	{
		...
		{
			if ($mode == 'top')  print_left_oblyon_menu_layout($this->db,$this->menu_array,$this->menu_array_after,$this->tabMenu,$this->menu,0);
			if ($mode == 'left') print_oblyon_menu_layout($this->db,$this->atarget,$this->type_user,$this->tabMenu,$this->menu,0,'','',$moredata);
		}
