...
if ($search_status == '') $search_status = 2; // always display active thirdparty first
...
if ($type == 'c' && (empty($search_type) || ($search_type == '1,3'))) $title = $langs->trans("ListOfPendingCustomers");
