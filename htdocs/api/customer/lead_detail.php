<?php
	...
	if($userExists)
	{
		...
		$sql = "SELECT DISTINCT p.rowid as id, p.ref, p.title, p.fk_statut as status, p.tech_assigndatetime, p.fk_product, fk_brand, fk_category, fk_sub_category, fk_model, fk_product";
