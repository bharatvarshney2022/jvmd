<?php
	...
	if($isExist)
	{
		...
		$isExist->kyc1 = $isExist->kyc2 = $isExist->beneficial_name = $isExist->bank_name = $isExist->ifsc_code = $isExist->account_number = $isExist->bank_branch_name = $isExist->pan_number = '';
