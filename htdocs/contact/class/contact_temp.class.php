 ...
 */
class ContactTemp extends CommonObject
{
	/**
	 * @var string ID to identify managed object
	 */
	public $element = 'contact_temp';

	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'socpeople_temp';
	...
	{
		$sql = "SELECT rowid, firstname, lastname, email, phone_mobile, otp";
		$sql .= ' FROM '.MAIN_DB_PREFIX.$this->table_element;
