...
llxHeaderLayout('', $langs->trans("UserCard"), $langs->trans("UserCard"));
							...
							<div class="row">
								<div class="col-lg-12">
									...
									<div class="card card-custom gutter-b">
										'.
										load_fiche_titre_layout($langs->trans("NewUser"), '', '').

										'<div class="card-footer">';

										print '<p>'.$langs->trans("CreateInternalUserDesc")."</p>";
										...
										<div class="card-body">';
											...
											print dol_get_fiche_head_layout('', '', '', 0, '');
											...
											// Civility
											print '<tr style="display:none;"><td><label for="civility_code">'.$langs->trans("UserTitle").'</label></td><td colspan="3">';
											...
											if (!empty($ldap_firstname))
											{
												...
												print '<input class="form-control" type="text" name="firstname" value="'.dol_escape_htmltag(GETPOST('firstname', 'alphanohtml')).'">';
											}
											print '</td><td class=""><span class="fieldrequired">'.$langs->trans("Lastname").'*</span></td>';
											print '<td>';
											if (!empty($ldap_lastname))
											{
												...
												print '<input class="form-control" type="text" id="lastname" name="lastname" value="'.dol_escape_htmltag(GETPOST('lastname', 'alphanohtml')).'">';
											}
											print '</td></tr>';
											...
											} elseif (!empty($ldap_loginsmb))
											{
												...
												print '<input class="form-control" maxsize="24" type="text" name="login" value="'.dol_escape_htmltag(GETPOST('login', 'alphanohtml')).'">';
											}
											print '</td>';
											...
											if (preg_match('/dolibarr/', $dolibarr_main_authentication))
											{
												if (!empty($ldap_pass))	// For very old system comaptibilty. Now clear password can't be viewed from LDAP read
												{
													...
													$valuetoshow .= ($valuetoshow ? ', ' : '').'<input size="30" class="form-control" maxsize="32" type="text" name="password" value="'.$password.'" autocomplete="new-password">';
												}
											}
											...
											if (!empty($ldap_mobile))
											{
												...
												print '<input class="form-control" type="text" name="user_mobile" value="'.dol_escape_htmltag(GETPOST('user_mobile', 'alphanohtml')).'">';
											}
											print '</td>';

											// EMail
											print '<td'.(!empty($conf->global->USER_MAIL_REQUIRED) ? ' class="fieldrequired"' : '').'>'.$langs->trans("EMail").'</td>';
											print '<td>';
											...
											if (!empty($ldap_mail))
											{
												...
												print '<input type="text" name="email" class="form-control" value="'.dol_escape_htmltag(GETPOST('email', 'alphanohtml')).'">';
											}
											print '</td></tr>';
											...
											// Gender
											print '<tr style="display:none;"><td>'.$langs->trans("Gender").'</td>';
											print '<td>';
											...
											print "</tr>\n";
											// External user
											print '<tr style="display:none;"><td>'.$langs->trans("ExternalUser").' ?</td>';
											print '<td>';
											...
											{
												print '<td>'.$form->editfieldkey('State', 'state_id', '', $object, 0).'</td><td class="maxwidthonsmartphone">';
											...
											if (!empty($ldap_phone))
											{
												...
												print '<input class="form-control" type="text" name="office_phone" value="'.dol_escape_htmltag(GETPOST('office_phone', 'alphanohtml')).'">';
											}
											print '</td></tr>';

											// Fax
											print '<tr style="display:none;"><td>'.$langs->trans("Fax").'</td>';
											print '<td>';
											...
											if (!empty($conf->socialnetworks->enabled)) {
												foreach ($socialnetworks as $key => $value) {
													if ($value['active']) {
														print '<tr style="display:none;"><td>'.$langs->trans($value['label']).'</td>';
														print '<td>';
											...
											{
												print '<tr style="display:none;"><td>'.$langs->trans("AccountancyCode").'</td>';
												print '<td>';
											...
											{
												print '<tr style="display:none;"><td>'.$langs->trans("ColorUser").'</td>';
												print '<td>';
											...
											{
												print '<tr style="display:none;" ><td>'.$form->editfieldkey('Categories', 'usercats', '', $object, 0).'</td><td colspan="3">';
											...
											{
												print '<tr style="display:none;"><td>'.$form->editfieldkey('DefaultLang', 'default_lang', '', $object, 0).'</td><td colspan="3" class="maxwidthonsmartphone">'."\n";
											...
											// Signature
											print '<tr style="display:none;"><td class="tdtop">'.$langs->trans("Signature").'</td>';
											print '<td>';
											require_once DOL_DOCUMENT_ROOT.'/core/class/doleditor.class.php';
											...
											print '</table><hr style="display:none;"><table class="border centpercent" style="display:none;">';
											...
											print '<input class="btn btn-info button-save" value="'.$langs->trans("CreateUser").'" name="create" type="submit">';
											print '&nbsp; &nbsp; &nbsp;';
											print '<input value="'.$langs->trans("Cancel").'" class="btn btn-warning button-cancel" type="reset" name="cancel">';
											print '</div>';
								...
								<div class="col-lg-12">
									...
									<div class="card card-custom gutter-b">
										<div class="card-footer">';
											...
											print dol_get_fiche_head_layout($head, 'user', $title, -1, 'user');
									...
									// Employee
									print '<tr style="display:none;"><td>'.$langs->trans("Employee").'</td><td colspan="2">';
									...
									if (empty($object->fk_user)) {
										...
										print $huser->firstname." ".$huser->lastname;
									}
									print '</td>';
									print "</tr>\n";
									...
									// Position/Job
									print '<tr style="display:none;"><td>'.$langs->trans("PostOrFunction").'</td>';
									...
									// Weeklyhours
									print '<tr style="display:none;"><td>'.$langs->trans("WeeklyHours").'</td>';
									print '<td>';
									...
									// Date employment
									print '<tr style="display:none;"><td>'.$langs->trans("DateOfEmployment").'</td>';
									print '<td>';
									...
									// Date login validity
									print '<tr style="display:none;"><td>'.$langs->trans("RangeOfLoginValidity").'</td>';
									print '<td>';
									...
									// Date of birth
									print '<tr style="display:none;"><td>'.$langs->trans("DateOfBirth").'</td>';
									print '<td>';
									...
									//print_r($object);
									// firstname
									print '<tr><td class="tdtop">'.$langs->trans('Full name').'</td><td>';
									print dol_htmlentitiesbr($object->firstname)." ".dol_htmlentitiesbr($object->lastname);
									print "</td></tr>\n";

									//Email
									print '<tr><td class="tdtop">'.$langs->trans('Email').'</td><td>';
									print dol_htmlentitiesbr($object->email);
									print "</td></tr>\n";

									// Mobile
									print '<tr><td class="tdtop">'.$langs->trans('PhoneMobile').'</td><td>';
									print dol_htmlentitiesbr($object->user_mobile);
									print "</td></tr>\n";
									...
									if (!empty($conf->categorie->enabled) && !empty($user->rights->categorie->lire))
									{
										print '<tr style="display:none;"><td>'.$langs->trans("Categories").'</td>';
										print '<td colspan="3">';
									...
									print '<tr style="display:none;"><td class="titlefield">'.$langs->trans("LastConnexion").'</td>';
									print '<td>'.dol_print_date($object->datelastlogin, "dayhour").'</td>';
									print "</tr>\n";

									print '<tr style="display:none;"><td>'.$langs->trans("PreviousConnexion").'</td>';
									...
									{
										print '<tr style="display:none;"><td>'.$langs->trans("LinkToCompanyContact").'</td>';
										print '<td>';
										$s = '';
									...
									// Signature
									print '<tr style="display:none;"><td class="tdtop">'.$langs->trans('Signature').'</td><td>';
									print dol_htmlentitiesbr($object->signature);
									print "</td></tr>\n";

									//VCard
									print '<tr style="display:none;"><td class="tdtop">'.$langs->trans("VCard").'</td>';
									print '<td>';
								...
								<div class="col-lg-12">
									...
									<div class="card card-custom gutter-b">
										<div class="card-footer">';
											...
											print dol_get_fiche_head_layout($head, 'user', $title, 0, 'user');
										...
										<div class="card-body">';
											...
											print '<input type="hidden" name="entity" value="'.$object->entity.'">';
												...
												{
													print '<input class="form-control" type="text" class="flat" name="firstname" value="'.$object->firstname.'">';
												} else {
												...
												if ($caneditfield && !$object->ldap_sid)
												{
													print '<input class="form-control" type="text" class="flat" name="lastname" value="'.$object->lastname.'">';
												} else {
												...
												{
													print '<input maxlength="50" type="text" class="form-control" name="login" value="'.$object->login.'">';
												} else {
												...
												if (preg_match('/dolibarr/', $dolibarr_main_authentication))
												{
													if ($caneditpassword)
													{
														$valuetoshow .= ($valuetoshow ? (' '.$langs->trans("or").' ') : '').'<input maxlength="32" type="password" class="form-control" name="password" value="'.$object->pass.'" autocomplete="new-password">';
													} else {
												...
												// Administrator
												print '<tr style="display:none;"><td>'.$langs->trans("Administrator").'</td>';
												if ($object->socid > 0)
												{
													$langs->load("admin");
													print '<td>';
												...
												{
													print '<input type="text" name="user_mobile" class="form-control" value="'.$object->user_mobile.'">';
												} else {
												...
												if ($caneditfield && empty($object->ldap_sid))
												{
													print '<input class="form-control" type="text" name="email" class="flat" value="'.$object->email.'">';
												} else {
												...
												// Hierarchy
											   	...
											   	{
											   		if($user->admin){
											   			print $form->select_dolusers($object->fk_user, 'fk_user', 1, array($object->id), 0, '', 0, $object->entity, 0, 0, '', 0, '', 'form-control');
											   		}else{

											   			print $form->select_dolusers($object->fk_user, 'fk_user', 1, array($object->id), 1, '', 0, $object->entity, 0, 0, '', 0, '', 'form-control');
												...
												print '</td></tr>';
											   	...
											   	print '</table><hr><table class="table table-bordered">';


												// Address
												print '<tr><td class="tdtop titlefield">'.$form->editfieldkey('Address', 'address', '', $object, 0).'</td>';
												print '<td colspan="4">';
												if ($caneditfield) print '<textarea name="address" id="address" class="form-control" rows="3" wrap="soft">';
												print $object->address;
												...
												if (empty($conf->global->USER_DISABLE_STATE))
												{
													print '<td class="tdoverflow">'.$form->editfieldkey('State', 'state_id', '', $object, 0).'</td><td>';
													if ($caneditfield) {
														print $formcompany->select_state($object->state_id, $object->country_code, 'state_id');
													} else {
												...
												if (isset($conf->file->main_authentication) && preg_match('/openid/', $conf->file->main_authentication) && !empty($conf->global->MAIN_OPENIDURL_PERUSER))
												{
													...
													if ($caneditfield)
													{
														print '<input class="form-control" type="url" name="openid" class="flat" value="'.$object->openid.'">';
													} else {
												...
												print '</table><hr><table class="table table-bordered">';
														...
														if (!empty($conf->categorie->enabled) && !empty($user->rights->categorie->lire))
														{
															print '<tr style="display:none;"><td>'.$form->editfieldkey('Categories', 'usercats', '', $object, 0).'</td>';
															print '<td>';
														...
														print '<div class="center">';
														print '<input value="'.$langs->trans("Save").'" class="btn btn-info button-save" type="submit" name="save">';
														print '&nbsp; &nbsp; &nbsp;';
														print '<input value="'.$langs->trans("Cancel").'" class="btn btn-warning button-cancel" type="submit" name="cancel">';
														print '</div>';
