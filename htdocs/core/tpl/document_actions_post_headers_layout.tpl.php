...
$disablemove = 1;
if (in_array($modulepart, array('product_customer', 'product', 'produit', 'societe', 'user', 'ticket', 'holiday', 'expensereport'))) $disablemove = 0;
...
print '<div class="card-body"><div class="row"><div class="col-sm-12">';

// Show upload form (document and links)
$formfile->form_attach_new_file_layout(
...
// List of document
$formfile->list_of_documents_layout(
	$filearray,
	$object,
	$modulepart,
	$param,
...
//List of links
$formfile->listOfLinksLayout($object, $permission, $action, GETPOST('linkid', 'int'), $param);
print "</div></div></div>";
